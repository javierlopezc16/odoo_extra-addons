...
class AccountInvoiceReport(models.Model):
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.number, sub.industry_id, sub.date, sub.product_id, sub.partner_id, sub.country_id, sub.account_analytic_id,
    ...
    def _sub_select(self):
        select_str = """
                SELECT ail.id AS id,
                    ...
                    ai.number as number,
                    ail.product_id, ai.partner_id, ai.industry_id, ai.payment_term_id, ail.account_analytic_id,
                    u2.name AS uom_name,
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.id, ail.product_id, ail.account_analytic_id, ai.date_invoice, ai.id,
                    ai.partner_id, ai.industry_id, ai.payment_term_id, u2.name, u2.id, ai.currency_id, ai.journal_id,
